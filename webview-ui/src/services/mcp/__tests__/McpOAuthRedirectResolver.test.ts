...
describe("McpOAuthRedirectResolver", () => {
  ...
  describe("isLoopbackUrl", () => {
    it("should return true for http://127.0.0.1:48801/...", () => {
      McpOAuthRedirectResolver.isLoopbackUrl(
        "http://127.0.0.1:48801/mcp-auth/callback/abc",
      ).should.be.true();
    });
    ...
    it("should return false for vscode:// URLs", () => {
      McpOAuthRedirectResolver.isLoopbackUrl(
        "vscode://saoudrizwan.claude-dev/path",
      ).should.be.false();
    });
  ...
  describe("resolve", () => {
    it("should get fresh URL and mark registration invalid when no saved URL", async () => {
      ...
      const result = await McpOAuthRedirectResolver.resolve(
        undefined,
        "/mcp-auth/callback/abc123",
        getCallbackUrl,
      );
