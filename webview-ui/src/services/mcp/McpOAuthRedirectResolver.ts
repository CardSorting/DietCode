  ...
  static async resolve(
    ...
    const preferredPort =
      savedRedirectUrl !== undefined
        ? McpOAuthRedirectResolver.extractLoopbackPort(savedRedirectUrl)
        : undefined;
    ...
    const isRegistrationValid = McpOAuthRedirectResolver.isRedirectCompatible(
      savedRedirectUrl,
      redirectUrl,
    );
