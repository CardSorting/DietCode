      ...
      <svg width="100%" height="200" viewBox="0 0 400 200" className="swarm-svg">
        ...
        <g className="swarm-links">
          ...
          <line
            ...
            strokeDasharray="4 2"
          >
            <title>Peripheral Tool interconnection Bridge</title>
          </line>
        </g>
        ...
        <g className="swarm-nodes">
          ...
          />
          <text x="210" y="45" fill="#00E5FF" className="node-text">
            CORE_ORCHESTRATOR
          </text>

          {/* Sub-Agent Nodes */}
          <circle cx="100" cy="100" r="4" fill="#00E5FF" />
          <text x="110" y="105" fill="#555" className="node-text">
            SUB_AGENT_01
          </text>

          <circle cx="300" cy="100" r="4" fill="#00E5FF" />
          <text x="310" y="105" fill="#555" className="node-text">
            SUB_AGENT_02
          </text>
