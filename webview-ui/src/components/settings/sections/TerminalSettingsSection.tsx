...
import type { UpdateTerminalConnectionTimeoutResponse } from '@shared/nice-grpc/index.cline.ts';
import {
  VSCodeCheckbox,
  VSCodeDropdown,
  VSCodeOption,
        ...
        <div className="mb-5" id="terminal-settings-section">
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-(--vscode-descriptionForeground)">
              Set how long Cline waits for shell integration to activate before executing commands.
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-(--vscode-descriptionForeground)">
              When enabled, Cline will reuse existing terminal windows that aren't in the current
              working directory. Disable this if you experience issues with task lockout after a
              terminal command.
            </p>
          </div>
          {isVsCodePlatform && (
