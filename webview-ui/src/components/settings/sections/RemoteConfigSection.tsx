...
function BaseRemoteConfigSection({
  renderSectionHeader,
  children,
    ...
    <div className="mb-4">
      ...
      <div className="bg-vscode-textBlockQuote-background rounded p-3 mb-2">
        ...
        {blobStoreConfig.endpoint && (
          <SettingRow label="Endpoint" value={blobStoreConfig.endpoint} />
        )}
        {blobStoreConfig.accountId && (
          <SettingRow label="Account ID" value={blobStoreConfig.accountId} />
        )}
        ...
        {blobStoreConfig.intervalMs && (
          <SettingRow label="Sync Interval" value={`${blobStoreConfig.intervalMs}ms`} />
        )}
        {blobStoreConfig.batchSize && (
          <SettingRow label="Batch Size" value={blobStoreConfig.batchSize} />
        )}
        {blobStoreConfig.maxRetries && (
          <SettingRow label="Max Retries" value={blobStoreConfig.maxRetries} />
        )}
        {blobStoreConfig.maxQueueSize && (
          <SettingRow label="Max Queue Size" value={blobStoreConfig.maxQueueSize} />
        )}
