...
function InfoCard({ icon, children }: { icon: React.ReactNode; children: React.ReactNode }) {
  return (
    ...
    >
      <div className="min-w-[22px] h-[22px] flex items-center justify-center shrink-0 mt-2">
        {icon}
      </div>
  ...
  return (
    <div>
      {!ready ? (
        ...
        <div>
          <div
            className={`flex items-center justify-between mt-0 mb-0 [color:var(${VSC_DESCRIPTION_FOREGROUND})]`}
          >
