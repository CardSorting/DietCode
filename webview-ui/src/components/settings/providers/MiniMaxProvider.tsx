...
import { minimaxModels } from "@shared/api.ts";
...
export const MinimaxProvider = ({
  ...
  return (
    <div>
      ...
      >
        Select the API endpoint according to your region: <code>api.minimaxi.com</code> for China,
        or <code>api.minimax.io</code> for all other locations.
      </p>
      <ApiKeyField
