      ...
      {showModelOptions && (
        <>
          ...
          {modeFields.awsBedrockCustomSelected && (
            <div>
              <p className="mt-1 text-sm text-description">
                Select "Custom" when using the Application Inference Profile in Bedrock. Enter the
                Application Inference Profile ARN in the Model ID field.
              </p>
              <DebouncedTextField
          ...
          {(SUPPORTED_BEDROCK_THINKING_MODELS.includes(selectedModelId) ||
            (modeFields.awsBedrockCustomSelected &&
              ...
              SUPPORTED_BEDROCK_THINKING_MODELS.includes(
                modeFields.awsBedrockCustomModelBaseId,
