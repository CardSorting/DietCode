...
const ConfigureServersView = () => {
  ...
  const hasRemoteMCPServers =
    remoteConfigSettings?.remoteMCPServers && remoteConfigSettings.remoteMCPServers.length > 0;
  ...
  return (
    <div style={{ padding: "16px 20px" }}>
      ...
      >
        ...
        resources to extend DietCode's capabilities. You can use{" "}
        <VSCodeLink
        ...
        or ask DietCode to create new tools specific to your workflow (e.g., "add a tool that gets
        the latest npm docs").{" "}
        <VSCodeLink
