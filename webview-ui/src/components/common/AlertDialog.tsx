...
import { OPENROUTER_MODEL_PICKER_Z_INDEX } from "../settings/ApiOptions";
...
export function AlertDialogDescription({
  ...
  return (
    <p
      className={`text-(--vscode-descriptionForeground) text-sm text-left ${className}`}
      {...props}
    />
  );
}
...
export function AlertDialogAction({
  className,
  ...props
}: React.ComponentProps<typeof VSCodeButton>) {
