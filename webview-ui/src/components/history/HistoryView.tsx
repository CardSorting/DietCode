import { BooleanRequest, EmptyRequest, StringArrayRequest } from "@shared/nice-grpc/cline/common.ts"
import { GetTaskHistoryRequest, TaskFavoriteRequest } from "@shared/nice-grpc/cline/task.ts"
