...
import { Remediator, type RemediationStep } from './Remediator';
...
export class SelfHealer {
     ...
     */
    async healProject(options: { dryRun?: boolean; onProgress?: (step: RemediationStep) => void } = {}): Promise<HealingReport> {
