...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
  return {
    ...
    planModeAwsBedrockCustomModelBaseId: config.planModeAwsBedrockCustomModelBaseId as
      | string
      | undefined,
    ...
    actModeAwsBedrockCustomModelBaseId: config.actModeAwsBedrockCustomModelBaseId as
      | string
      | undefined,
...
export function convertProtoToApiConfiguration(
  ...
  return {
    ...
    planModeAwsBedrockCustomModelBaseId: protoConfig.planModeAwsBedrockCustomModelBaseId as
      | BedrockModelId
      | undefined,
    ...
    actModeAwsBedrockCustomModelBaseId: protoConfig.actModeAwsBedrockCustomModelBaseId as
      | BedrockModelId
      | undefined,
